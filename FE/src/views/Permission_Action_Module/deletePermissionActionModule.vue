<template>
    <div class="d-inline">
        <Delete @click="openModal" class="custom-button-h" />
        <Dialog
            header="Xoá thao tác module"
        ...
        >
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <label for="note">Chọn thao tác cần xoá<b class="p-error">*</b></label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-12">
    ...
    export default {
        ...
        methods: {
            ...
            async handleDelete() {
                ...
                await HTTP.put(`PermissionActionModule/deleteMultiPermissionActionModule`, addMduleActions)
                    .then((res) => {
                        this.closeModal()
                        this.$emit('render')
                        this.$toast.add({
            ...
            async confirmDelete(data) {
                this.$confirm.require({
                    message: "Bạn có chắc chắn muốn xóa những thao tác này?",
                    header: "Xóa",
