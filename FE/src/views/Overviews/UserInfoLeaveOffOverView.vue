<template>
    <h5>{{ selectedallUser ? 'Thống kê tổng hợp nghỉ phép' : 'Thống kê nghỉ phép' }}</h5>
    <div class="container-fluid" style="margin-top: 2rem">
        <div class="row mb-3">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6 mb-3"> 
                        <date-picker
                            ...
                            :popover-append-to="'.parent-element-class' + filterLeaveOff.sortMonth"
                        ></date-picker>
                    </div>
                    <div class="col-sm-12 col-md-6 col-lg-6 mb-3"> 
                        <div v-if="selectedallUser"> 
                            <Dropdown
                                class="custom-input-h"
                                :id="'selectedIdUser' + filterLeaveOff.selectedIdUser"
                                :filter="true"
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 d-flex justify-content-end">
                ...
                <div class="p-1 mb-2 d-flex justify-content-center align-items-center" style="border-radius: 2px">
                    <div class="bg-danger text-white" style="width: 20px; height: 20px"></div>
...
<style>
    ...
    .custom-home .mx-datepicker .mx-input-wrapper input {
        padding: 24px;
    }
</style>
