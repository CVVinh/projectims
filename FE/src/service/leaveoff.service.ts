...
export class LeaveOffService {
    ...
    public static handlerFilterLeaveOffLead(idLead: Number, pageIndex: Number, pageSize: Number, object: any) {
        return HTTP.post(
            ApiApplication.LEVAEOFF.FILTER_LEAVEOFF_BY_DATE_NAME_STATUS_LEAD(idLead, pageIndex, pageSize),object,)
    }
    public static handlerFilterLeaveOffPM(idPM: Number, pageIndex: Number, pageSize: Number, object: any) {
        return HTTP.post(
            ApiApplication.LEVAEOFF.FILTER_LEAVEOFF_BY_DATE_NAME_STATUS_PM(idPM, pageIndex, pageSize),object,)
    }
