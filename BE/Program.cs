...
builder.Services.AddScoped<ITimeSheetDailyServices, TimeSheetDailyServices>();
...
builder.Services.AddScoped<IPaginationServices<ReviewResult>, PaginationServices<ReviewResult>>();
builder.Services.AddScoped<IPaginationServices<StaffReviewDto>, PaginationServices<StaffReviewDto>>();
builder.Services.AddScoped<IPaginationServices<StaffReviewTime>, PaginationServices<StaffReviewTime>>();
builder.Services.AddScoped<IPaginationServices<GetAllMultiStaffViewTimeDto>, PaginationServices<GetAllMultiStaffViewTimeDto>>();
...
builder.Services.AddScoped<IPostCategoryServices, PostCategoryService>();
builder.Services.AddScoped<IStaffReviewTimeService, StaffReviewTimeService>();
builder.Services.AddScoped<IPaginationServices<StaffReviewTime>, PaginationServices<StaffReviewTime>>();
builder.Services.AddScoped<IPaginationServices<TimeSheetDaily>, PaginationServices<TimeSheetDaily>>();
builder.Services.AddScoped<IPaginationServices<ResponseTimeSheetDailyDto>, PaginationServices<ResponseTimeSheetDailyDto>>();
#endregion
